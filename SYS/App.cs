...
namespace kBit.ERP.SYS
{
    public static class App
    {
        ...
        //todo: public static FileLog AccessLog = new FileLog();
        ...
        public static bool Init()
        {
            ...
            {
                //todo: uncomment ErrorLogFacade.LogToFile(ex);
            }
            // Database connection: open/test
            try
            {
                fSplash.ShowMsg("Connecting to the SqlFacade...");
                //SqlFacade.Connection = new PetaPoco.Database(SqlFacade.ConnectionString, "NpgSql");                                                
